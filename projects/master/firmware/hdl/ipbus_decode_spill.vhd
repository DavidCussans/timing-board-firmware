...
end ipbus_decode_spill;

package body ipbus_decode_spill is

  function ipbus_sel_spill(addr : in std_logic_vector(31 downto 0)) return ipbus_sel_t is
